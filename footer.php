...
<div class="footer contact-us" id="footer">
		...
		<div class="contact1">
			<p>
				<span>Dhruvil Dave</span><br>
				<span>Mobile Number : **********</span><br>
				<span>Email : <a href="Mailto:dhruvildave45@gmail.com">dhruvildave45@gmail.com</a></span>
			</p>
			<a id="fa-hand" href="" title="See Link" style="color: red;"><i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
    		<a id="fa-facebook" href="" title="Facebook" style="color: #3b5998;"><i class="fab fa-facebook-square" aria-hidden="true"></i></a>
    		<a id="fa-insta" href="" title="Instagram" style="color: #FE0883;"><i class="fab fa-instagram" aria-hidden="true"></i></a>
    		<a id="fa-tele" href="" title="Telegram" style="color:  #0088cc;"><i class="fab fa-telegram" aria-hidden="true"></i></a>
    		<a id="fa-linkin" href="" title="Linkedin" style="color: #0e76a8;"><i class="fab fa-linkedin-square" aria-hidden="true"></i></a>
		</div>
		
		<br clear="all">
		<div class="foot">
			<h1 style="font-family: cursive;">© E-Reservation System... All Rights Reserved 2020</h1>
		</div>
	</div>
</div>