...
<div class="site-name" id="navbar">
			...
			<div class="menu-list">
				<ul>
					...
					<a class="border-style" href="donate.html">Donate</a>
					<a class="border-style" href="about.html">About Us</a>
					<a class="border-style" href="contact.html">Contact Us</a>
			<?php if (isset($_SESSION['mail']))
				...
				<?php	}else{ ?>
					...
					<?php } }else{ ?>
						<a class="border-style" href="login.html">Login</a>
					<?php } ?>
				</ul>
			</div>
		</div>